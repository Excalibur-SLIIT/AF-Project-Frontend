...
export default class allEditor extends Component {
    ...
    componentDidMount(){
        ...
        .then(response =>{
            ...
            this.setState({editors: response.data.results})
            
            let filteredUsers = [];
            filteredUsers = response.data.results.filter((user) => user.role === "editor");
            this.setState({editors: filteredUsers})
