...
export default class allWorkShopCon extends Component {
    ...
    componentDidMount(){
        ...
        .then(response =>{
            ...
            this.setState({workshopCons: response.data.results})
            
            let filteredUsers = [];
            filteredUsers = response.data.results.filter((user) => user.role === "workshop-conductor");
            this.setState({workshopCons: filteredUsers})
        ...
        return (
            <div>
                ...
                <table class="table table-hover">
                            ...
                            <tbody>
                                {this.state.workshopCons.length > 0 && this.state.workshopCons.map((item, index)=>(
