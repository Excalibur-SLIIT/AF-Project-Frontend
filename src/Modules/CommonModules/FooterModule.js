...
class FooterModule extends Component {
    render() {
        return (
            <div>
                <div class="container-fluid text-lg-start bg-light self-align-end p-5 mb-0 bg-body rounded">
                    <div class="row text-center text-md-start mt-5">
                        <div class="row mt-3">
                            ...
                            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                                ...
                                <p><a href="/addevent" class="text-reset">Add Event</a></p>
                                <p><a href="/admin/dashboard" class="text-reset">Dashboard</a></p>
